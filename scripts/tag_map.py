# =============================================
# WISSLIST - 태그 매핑 (확장 버전)
# 수정 가이드: 이 파일만 수정하면 됩니다
# =============================================
...
CATEGORY_QUERIES = {
    "kitchen":       ["kitchen cooking","food preparation","kitchen appliance",
                       "air fryer cooking","microwave food","instant noodles"],
    "food":          ["korean food","delicious meal","food close up",
                       "delivery food","chicken","frozen food","dessert sweet"],
    "lifestyle":     ["daily life","home living","cozy interior",
    ...
    "text_bg":       ["minimal background","white background","marble background",
                       "wood table","clean simple"],
    "emotion":       ["person expression","happy surprised","satisfied smile",
                       "disappointed reaction","shocked reaction","thumbs up",
                       "person eating popcorn"],
    "money_price":   ["shopping purchase","price tag","discount sale",
...
GIF_CATEGORY_QUERIES = {
    "reaction_gif": [
        ...
        "amazing wow","thumbs up reaction","frustrated annoyed","mind blown",
    ],
    "food_gif": [
